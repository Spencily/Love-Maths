...
function runGame(gameType) {
    ...
    document.getElementById("answer-box").value = ""; //Empties the answer box after pressing submit
    document.getElementById("answer-box").focus(); //Cursor will be in the box ready to type in the answer
...
/**
 * Checks the answer against the first element in the returned calulateCorrectAnswer array.
 */
...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`That is incorrect, you answered ${userAnswer} but the correct answer was ${calculatedAnswer[0]}!`);
